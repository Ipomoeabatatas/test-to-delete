...
//        languageContainer.setClickable(false);
        ...
        Button buttonShopping = view.findViewById(R.id.button_overseas);
        Button buttonReturns = view.findViewById(R.id.button_soiclub);
        Button buttonId = view.findViewById(R.id.button_internship);
